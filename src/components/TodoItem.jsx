function TodoItem(props) {
  return (
    <div className="todo-item">
      ...
      <div className={`todo-delimiter ${props.activeColor}`}></div>
      <p className="todo-text">{props.text}</p>
      <div className="todo-actions">
        <svg onClick={props.updateTask} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 384">
          <path d="M0 304v80h80l236-236-80-80zM378 56L328 6c-8-8-22-8-30 0l-39 39 80 80 39-39c8-8 8-22 0-30z"></path>
        </svg>
        <svg onClick={props.removeTask} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
